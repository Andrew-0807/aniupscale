...
local CFG = {
    -- Panel
    panel_color  = "1e1e2e",   -- Catppuccin Mocha Base
    ...
    time_color   = "a6adc8",   -- Catppuccin Mocha Subtext 0
    btn_color    = "bac2de",   -- Catppuccin Mocha Subtext 1

    -- Seekbar track (empty part)
    track_color  = "45475a",   -- Catppuccin Mocha Surface 1
...
mp.add_key_binding("UP",            "nova-volup",  function() mp.commandv("add","volume", 5); show_osc() end)
mp.add_key_binding("DOWN",          "nova-voldn",  function() mp.commandv("add","volume",-5); show_osc() end)
